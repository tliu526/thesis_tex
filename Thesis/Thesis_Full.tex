...
%s, while Stencils and Rule Tables will be explored in Section \ref{sec:StencilGen}.
...
in our examination of the $\lambda$ parameter. We will discuss the methods for generating 
these degraded grids here.
...
\begin{figure}
\centering
%TODO add genpt_degen figure
%\includegraphics[width=0.5\textwidth]{vquad_generation}
\caption[Generator Point Degradation]{
  A VQuad grid degraded by the removal of input generator points. Notice the lack of small ``holes'' in the resulting grid.
}
