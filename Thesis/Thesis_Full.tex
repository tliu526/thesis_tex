...
\begin{figure}[htp]
\centering
\includegraphics[width=1.0\textwidth]{voronoi_generation}
\caption[Voronoi Diagram Generation]{
	The Voronoi Diagram construction process. We begin with a random set of points (left), compute the Delaunay Triangulation (center), and subsequently the Voronoi Diagram (right).
